...
public class AlchemyGroveBiome extends Region {
    public AlchemyGroveBiome(Identifier name, int weight) {
...
/*        // Overlap Vanilla's parameters with our own for our COLD_BLUE biome.
        ...
        addBiomeSimilar(mapper,BiomeKeys.FOREST, AlchemyBiomeKeys.Maple_Grove);
    }
}
