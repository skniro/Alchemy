...
;
        ...
        translationBuilder.add(AlchemyItems.KARMINE_VENOM,"卡明毒液");
        ...
        translationBuilder.add(AlchemyItems.PALMA_FRUIT,"帕尔马果实");
